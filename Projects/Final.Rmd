...
> Can be non-parameter as we make no assumption about the functional form of predicted variables – in fact,
There does not seem to be any response variable, which makes it an interdependence issue: prediction does not seem to be relevent. We will go for a descriptive method, e.g. PCA or clustering
